...
static const char *colors[][3]	= {
	/*               fg         bg         border   */
	[SchemeNorm] = { text, base, mauve },
	[SchemeSel]  = { text, base,  sky  },
};
...
static const char *lightup[]	= { "light", "-A", "1", NULL };
static const char *lightdown[]	= { "light", "-U", "1", NULL };
